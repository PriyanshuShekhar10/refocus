# Graph Report - refocus  (2026-08-24)

## Corpus Check
- 559 files · ~254,796 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3330 nodes · 6847 edges · 229 communities (215 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 32 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14f082fc`
...
1. `getDb()` - 243 edges
2. `checkRateLimit()` - 78 edges
3. `rateLimitedResponse()` - 73 edges
4. `requireVerifiedEmail()` - 66 edges
5. `requireAdmin()` - 65 edges
6. `authOptions` - 65 edges
7. `publish()` - 40 edges
8. `resolveAvatarUrl()` - 37 edges
9. `publishAbly()` - 37 edges
10. `mockCollection()` - 31 edges
...
- `Profile()` --calls--> `useWallpaperActive()`  [EXTRACTED]
  app/(product)/components/profile.tsx → components/wallpaper-context.tsx
...
Cohesion: 0.16
Nodes (22): getOpsNotifyEmail(), notifyOpsSessionMatched(), notifyOpsSignup(), sendOpsEmail(), DEFAULT_OPS_NOTIFY_PREFS, getOpsNotifyPrefs(), isOpsNotifyKindEnabled(), normalizePrefs() (+14 more)
...
Cohesion: 0.38
Nodes (7): isValidReportReason(), isValidReportTargetType(), ReportValidationError, ResolvedReportTarget, resolveReportTarget(), truncateSnapshot(), POST()
...
Cohesion: 0.09
Nodes (31): PATCH(), isSoloOpen(), POST(), SessionDoc, SessionParticipant, soloUserId(), POST(), GET() (+23 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (15): bricolage, geistMono, geistSans, metadata, quicksandSans, siteUrl, gaId, GoogleAnalytics() (+7 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (34): GET(), GET(), GET(), GET(), GET(), SessionDoc, DELETE(), deleteManagedAvatar() (+26 more)
...
Cohesion: 0.22
Nodes (10): Props, DropdownMenuCheckboxItem, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuRadioItem, DropdownMenuSeparator, DropdownMenuShortcut() (+2 more)
...
Cohesion: 0.14
Nodes (18): CalendarEventCard(), CalendarEventCardProps, COMPACT_PASTEL_COLORS_DARK, COMPACT_PASTEL_COLORS_LIGHT, isJoinable(), getResolvedSessionColor(), getSessionColorPresetIndex(), SESSION_COLOR_PRESETS (+10 more)
...
Cohesion: 0.12
Nodes (29): GET(), GET(), GET(), DURATION_OPTIONS, isBookingStartAligned(), GET(), MessageDoc, POST() (+21 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (19): ProfilePreviewPayload, Props, STEPS, WelcomeResponse, createAblyTokenRequest(), globalChatChannel(), sessionsChannel(), userChannel() (+11 more)

### Community 16 - "Community 16"
Cohesion: 0.20
Nodes (12): findUserByEmailIdentity(), addEngagementCrewMember(), displayName(), EngagementCrewMember, ensureCrewIndexes(), isEngagementCrewUserId(), resolveEngagementCrewMembers(), addedAt (+4 more)
...
Cohesion: 0.08
Nodes (42): POST(), SessionDoc, POST(), DELETE(), GET(), POST(), POST(), POST() (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (33): getCrewStats, req, mocks, req, db, friendRequestsCol, req, REQUEST_ID (+25 more)

### Community 21 - "Community 21"
Cohesion: 0.27
Nodes (11): GET(), buildDayKeys(), bump(), CrewDayCounts, CrewMemberStats, emptyDay(), getCrewStats(), istDateKey() (+3 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (20): LocalDateTime(), Props, formatRecentTime(), SessionCountdown(), SessionCountdownProps, formatLocalDate(), formatLocalDateTime(), formatLocalTime() (+12 more)
...
Cohesion: 0.09
Nodes (20): absorb, absorbId, adminId, areUsersBlocked, booked, db, end, FUTURE_END (+12 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (45): ApiError, ApiResult, create(), CreateSessionPayload, deleteSession(), getErrorMessage(), join(), leave() (+37 more)

### Community 26 - "Community 26"
Cohesion: 0.16
Nodes (29): DELETE(), DELETE(), DELETE(), DELETE(), DELETE(), PATCH(), DELETE(), POST() (+21 more)

### Community 27 - "Community 27"
Cohesion: 0.09
Nodes (18): Community(), CommunityProps, MobileCommunityView, PINNED_ADMIN_POST, ProfilePreviewPayload, AuthorLike, Comment, Post (+10 more)

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (16): devDependencies, autoprefixer, dotenv, eslint, eslint-config-next, @eslint/eslintrc, postcss, tailwindcss (+8 more)
...
Cohesion: 0.11
Nodes (24): CalendarSidebar(), BookSessionButton(), CreatedSession, Props, Calendar(), CalendarProps, ModalState, ProcessedEvent (+16 more)

### Community 31 - "Community 31"
Cohesion: 0.15
Nodes (11): EmailVerificationBanner(), EmailVerifiedBadge(), Props, Profile(), ABOUT_ME_PROMPTS, AboutMeKey, EditableFields, emptyAboutMe() (+3 more)
...
Cohesion: 0.23
Nodes (13): KnownIpEntry, LoginMethod, mergeKnownIps(), persistableIp(), recordLoginIp(), recordSeenIp(), recordSignupIp(), toDate() (+5 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (32): abs(), articleJsonLd(), breadcrumbJsonLd(), faqJsonLd(), organizationJsonLd(), publisherJsonLd(), SAME_AS, ../layouts/ContentPage.astro (+24 more)
...
Cohesion: 0.10
Nodes (16): useOnPageRefreshEvent(), PasswordStrengthMeter(), Props, STRENGTH_LABELS, AppearanceSection(), ChangePasswordSection(), DEFAULT_PREFS, EmailVerificationSection() (+8 more)

### Community 39 - "Community 39"
Cohesion: 0.17
Nodes (10): db, FUTURE_END, FUTURE_START, pastEnd, pastStart, req, SESSION_ID, sessionsCol (+2 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (19): ACTION_LABELS, AdminChatMessage, AdminPerson, AdminPost, AdminSection, AdminSessionRow, AdminUser, AuditEntry (+11 more)
...
Cohesion: 0.20
Nodes (15): isEmailBanned(), logBannedIpSignupAttempt(), displayEmail(), PasswordStrength, result, validatePassword(), POST(), generateUsername() (+7 more)
...
Cohesion: 0.07
Nodes (29): CalendarSidebarProps, DurationSelectorBaseProps, DurationSelectorProps, MultiSelectProps, SingleSelectProps, VARIANT_STYLES, UIState, CALENDAR_LAYOUT (+21 more)
...
Cohesion: 0.18
Nodes (24): ReminderRunResult, runMorningSessionReminders(), runTimedSessionReminders(), sendTimedReminderForSession(), SESSION_REMINDER_TIMINGS, SessionReminderTiming, bulkLoadReminderRecipients(), displayName() (+16 more)
...
Cohesion: 0.14
Nodes (21): HourOccupancyChip(), buildEventsByDay(), day0, day1, map, session, addHourKeys(), aggregateHourOccupancy() (+13 more)
...
Cohesion: 0.40
Nodes (5): code:bash (git clone https://github.com/YOUR_USERNAME/refocus.git), code:bash (git remote add upstream https://github.com/PriyanshuShekhar1), Fork and Clone, Getting Started, Prerequisites
...
Cohesion: 0.29
Nodes (3): MailRecipient, SearchHit, SentMessage
...
Cohesion: 0.40
Nodes (5): code:markdown (## Description), code:bash (# Run linting), Running Tests, Testing, Testing Checklist
...
Cohesion: 0.13
Nodes (16): FriendChatInputProps, CommunityChat(), CommunityChatProps, GlobalMessage, ChatMessage, FriendChat(), FriendChatProps, SessionRequestPayload (+8 more)
...
Cohesion: 0.09
Nodes (27): AdminChatMessage, AdminPost, AdminSection, AdminUser, NAV, Stats, BookSessionModal(), BookSessionModalProps (+19 more)

### Community 99 - "Community 99"
Cohesion: 0.13
Nodes (18): displayName(), notifySessionCancelled(), Participant, SessionLike, sessionTitleFor(), UserRow, displayName(), notifySessionMatched() (+10 more)
...
Cohesion: 0.08
Nodes (25): BacklogIssue, IssuePriority, IssueStatus, PRIORITY_STYLES, STATUS_COLUMNS, dispatchPageRefreshEvent(), PAGE_REFRESH_EVENTS, PageRefreshButton() (+17 more)
...
Cohesion: 0.06
Nodes (52): GET(), iso(), pushEvent(), TimelineEvent, AdminPage(), metadata, GET(), GET() (+44 more)

### Community 106 - "Community 106"
Cohesion: 0.07
Nodes (24): db, deletedCol, adminId, db, req, settingsCol, bannedEmailsCol, db (+16 more)

### Community 107 - "Community 107"
Cohesion: 0.25
Nodes (7): db, partnerId, req, resolveEngagementCrewMembers, sessionsCol, userId, usersCol

### Community 108 - "Community 108"
Cohesion: 0.18
Nodes (9): @fontsource/geist-mono/400.css, @fontsource/geist-mono/500.css, @fontsource-variable/bricolage-grotesque, ../../../layouts/Base.astro, careerJsonLd, jobPostingJsonLd, openRoles, ../components/Career (+1 more)
...
Cohesion: 0.09
Nodes (31): isDashboard, marketingUrl, metadata, siteUrl, robots(), siteUrl, sitemap(), siteUrl (+23 more)
...
Cohesion: 0.14
Nodes (15): formatUpcomingDate(), toYmd(), ChatDock(), Friend, OpenChat, FriendRequestData, FriendData, SessionRequestData (+7 more)
...
Cohesion: 0.28
Nodes (15): sendAdminUserEmail(), logResendFailure(), sendMatchedSessionEmail(), logResendFailure(), sendSessionCancelledEmail(), logResendFailure(), sendMorningSessionDigestEmail(), sendTimedSessionReminderEmail() (+7 more)
...
Cohesion: 0.67
Nodes (4): AdminPanel(), formatPercent(), localYmd(), shiftLocalYmd()
...
Cohesion: 0.31
Nodes (9): AdminTestCallResult, createAdminTestCall(), createDailyMeetingToken(), createOrGetDailyRoom(), isOwnerOrParticipant(), toObjectId(), isWithinCallWindow(), POST() (+1 more)
...
Cohesion: 0.18
Nodes (15): buildMatchedSessionEmail(), buildMorningSessionDigestEmail(), buildSessionCancelledEmail(), buildTimedSessionReminderEmail(), emailShell(), escapeHtml(), greeting(), sessionListHtml() (+7 more)

### Community 130 - "Community 130"
Cohesion: 0.11
Nodes (24): DELETE(), PATCH(), DELETE(), IssuePriority, IssueStatus, serializeIssue(), VALID_PRIORITIES, VALID_STATUSES (+16 more)

### Community 131 - "Community 131"
Cohesion: 0.07
Nodes (31): DayCounts, Member, MetricKey, METRICS, RANGE_OPTIONS, StatsPayload, CREW_METRIC_COLORS, CREW_METRICS (+23 more)
...
Cohesion: 0.22
Nodes (6): GET(), CrewSessionRow, getCrewMemberSessions(), Participant, GMAIL_DOMAINS, PLUS_ALIAS_DOMAINS

### Community 134 - "Community 134"
Cohesion: 0.15
Nodes (24): createInitialState(), uiReducer(), addDays(), clamp(), formatHour(), minutesBetween(), pad(), startOfDay() (+16 more)
...
Cohesion: 0.14
Nodes (10): db, END, JOINER_ID, lifecycleCol, notifySessionCancelled, OWNER_ID, req, SESSION_ID (+2 more)
...
Cohesion: 0.09
Nodes (17): MySessionsPage(), RawSession, UserDoc, Attendance, formatRelativeDay(), formatTime(), formatTotalMinutes(), HistorySummary() (+9 more)
...
Cohesion: 0.18
Nodes (10): ABOUT_ME_PROMPTS, generateMetadata(), getPublicUser(), getUser(), getViewableUser(), ProfileUser, Props, PublicProfilePage() (+2 more)

### Community 200 - "Community 200"
Cohesion: 0.10
Nodes (23): AuthLoadingOverlay(), AuthLoadingOverlayProps, AuthDivider(), FirebaseOAuthButtons(), ButtonAsAnchor, ButtonAsButton, CommonProps, DButton (+15 more)

### Community 201 - "Community 201"
Cohesion: 0.17
Nodes (11): bannedId, db, logSessionDeleted, matchedId, now, partnerId, publishSessionDocUpserted, publishSessionRemoved (+3 more)
...
Cohesion: 0.10
Nodes (14): CommunityChatPanel(), Props, useWallpaperActive(), WallpaperContext, EmptyCardProps, Friends(), FriendsProps, ListMode (+6 more)
...
Cohesion: 0.17
Nodes (10): CalendarRightSidebar(), CalendarRightSidebarProps, DetailedProfile, formatDate(), getGreeting(), AdminTag(), Props, Props (+2 more)

### Community 208 - "Community 208"
Cohesion: 0.31
Nodes (10): logResendFailure(), sendPasswordResetEmail(), SendPasswordResetEmailInput, hashVerificationToken(), createPasswordResetToken(), isPasswordResetTokenValid(), resetPasswordWithToken(), setPasswordResetToken() (+2 more)
...
Cohesion: 0.50
Nodes (4): ActiveTestCall, AdminTestCall(), CreateResponse, formatWhen()

### Community 211 - "Community 211"
Cohesion: 0.33
Nodes (11): applyUserModeration(), banEmail(), unbanEmail(), addBannedIpWatches(), BannedIpActivityOutcome, getBannedUserIps(), removeBannedIpWatchesForUser(), uniqueIps() (+3 more)

### Community 213 - "Community 213"
Cohesion: 0.08
Nodes (24): NotFound(), Hero(), HeroProps, LogoutButton(), MatchUser, ThemeSwitcher(), VideoModal(), SessionJoinPage() (+16 more)

### Community 214 - "Community 214"
Cohesion: 0.18
Nodes (5): UseCalendarSessionsOptions, UseCalendarSessionsReturn, SessionRealtimeEvent, SessionRemovedEvent, SessionUpsertedEvent
...
Cohesion: 0.24
Nodes (9): adminId, createAdminTestCall, listActiveAdminTestCalls, logAdminAction, req, isValidAdminTestDuration(), listActiveAdminTestCalls(), GET() (+1 more)

### Community 217 - "Community 217"
Cohesion: 0.21
Nodes (13): addEngagementCrewMember, adminId, listEngagementCrew, logAdminAction, removeEngagementCrewMember, req, DELETE(), GET() (+5 more)
...
Cohesion: 0.18
Nodes (9): db, hire, lifecycleCol, now, pending, resolveEngagementCrewMembers, sessionsCol, today (+1 more)

### Community 220 - "Community 220"
Cohesion: 0.53
Nodes (5): unauthorizedCronResponse(), verifyCronSecret(), handleTimedSessionReminderCron(), GET(), GET
...
Cohesion: 0.22
Nodes (6): DayCounts, Member, MetricKey, METRICS, RANGE_OPTIONS, StatsPayload

### Community 225 - "Community 225"
Cohesion: 0.43
Nodes (5): AudioContextConstructor, getAudioContextConstructor(), getOrCreateContext(), playSessionCompleteSound(), unlockSessionCompleteSound()
...
Cohesion: 0.33
Nodes (5): isMatchedSessionParticipants(), now, oneHour, { start, end, dayKey }, tenMin
...
## Knowledge Gaps
- **1515 isolated node(s):** `MUTATING_METHODS`, `PROTECTED_PREFIXES`, `config`, `crons`, `config` (+1510 more)
...
- **Why does `getDb()` connect `Community 105` to `Community 0`, `Community 130`, `Community 2`, `Community 132`, `Community 5`, `Community 133`, `Community 7`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 21`, `Community 26`, `Community 33`, `Community 45`, `Community 50`, `Community 180`, `Community 58`, `Community 198`, `Community 208`, `Community 211`, `Community 213`, `Community 216`, `Community 217`, `Community 98`, `Community 110`, `Community 116`, `Community 126`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `authOptions` connect `Community 7` to `Community 1`, `Community 98`, `Community 130`, `Community 132`, `Community 5`, `Community 198`, `Community 2`, `Community 105`, `Community 14`, `Community 15`, `Community 16`, `Community 50`, `Community 19`, `Community 180`, `Community 213`, `Community 23`, `Community 26`, `Community 126`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Homepage()` connect `Community 110` to `Community 43`, `Community 3`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
